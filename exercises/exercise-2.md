...
l m  
```
Implement the `updateHand` function. Make sure this function has no side effects (i.e., it must not mutate the hand passed in), and be sure you've passed the appropriate tests in `test_ps4a.py` before moving on to Exercise 3.
